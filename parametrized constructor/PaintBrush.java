class PaintBrush {
    ...
    public PaintBrush(String brand, String type, String bristleMaterial, String handleMaterial, String color, double length, double width,
        ...
        System.out.println("Details of the PaintBrush");
